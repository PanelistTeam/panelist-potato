...
class QuestionsVote(models.Model):
    ...
    user_id = models.ForeignKey(UserSocialAuth, on_delete=models.SET_NULL, db_column='user_id', blank=True, null=True)
    value= models.IntegerField(blank=True, null=True) 

class Privilege(models.Model):
    user_id = models.ForeignKey(UserSocialAuth, on_delete=models.CASCADE, db_column='user_id', blank=True, null=True)
    askroom_id = models.ForeignKey('Askroom', on_delete=models.CASCADE, db_column='askroom_id', blank=True, null=True)
